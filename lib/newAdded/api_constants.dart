...
const GET_EXOTIC_PRODUCT = "$BASE_URL/getExoticProduct";
const GET_CATEGORY_API = "$BASE_URL/getAllCategory";
const BUY_PRODUCT_API = "$BASE_URL/storeOrder";
const DISCOUNT_PRODUCT_API = "$BASE_URL/getDiscountProduct";
